...
* HSE Frequency(Hz)    = 25000000		HSE_VALUE 25MHz 外部晶振
* PLL_M                = 25
* PLL_N                = 336
* PLL_P                = 2
* PLL_Q                = 4
...
static void SystemClock_Config(void)
{
	...
	// f_vco = HSE_VALUE * PLLN / PLLM	168M
	// f_pll = f_vcl / PLLP							84M
	// f_usb = f_vco / PLLQ							42M
...
//选择PLL的输出作为系统时钟
//HCLK = SYSCLK / 1  (AHB1Periph)	168M
//PCLK2 = HCLK / 2   (APB2Periph)	84M
//PCLK1 = HCLK / 4   (APB1Periph)	42M
